...
Since figure 2 is now a tree map, I am switching to figure 3. I also don't think a heat map is going to show this well, so I'm switching to a scatterplot (with subgroups).
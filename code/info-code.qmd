...
treemap(ben_tree,
          ...
          # creates plot title
          title = "Distanced Walked (km) by \nLunch Location (black text) and Bus Trips (white text)",
          fontsize.title = 20,
          ...
          # adjusts font size on labels, 3rd layer has no labels since size already accounts for the value
